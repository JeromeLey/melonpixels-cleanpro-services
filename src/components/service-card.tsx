...
const iconMap: Record<string, React.ReactElement> = {
  ...
  Armchair: (
    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4M6 12V6a2 2 0 012-2h8a2 2 0 012 2v6m-8 0V8a2 2 0 012-2h2a2 2 0 012 2v4m-8 0h8" />
    </svg>
  ),
  Shield: (
    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function ServiceCard({ service }: ServiceCardProps) {
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-neutral-100">
      ...
      {service.pricing && (
        <p className="text-primary-600 font-semibold text-sm">{service.pricing}</p>
      )}
    </div>
  )
}